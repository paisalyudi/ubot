...
DEVS = list(map(int, os.getenv("DEVS", "7838767547").split()))

API_ID = int(os.getenv("API_ID", "23608953"))

API_HASH = os.getenv("API_HASH", "253f5f31989038f81ebf234f008df79f")

BOT_TOKEN = os.getenv("BOT_TOKEN", "7915132605:AAH3QmPkrY48-PkdD3POTUIbmqeoFgkZXIQ")

OWNER_ID = int(os.getenv("OWNER_ID", "7838767547"))
